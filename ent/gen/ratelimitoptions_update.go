...
func (rlou *RateLimitOptionsUpdate) SetDurationInSeconds(s string) *RateLimitOptionsUpdate {
	rlou.mutation.SetDurationInSeconds(s)
	return rlou
}

// SetThrottlePercentage sets the "throttle_percentage" field.
func (rlou *RateLimitOptionsUpdate) SetThrottlePercentage(s string) *RateLimitOptionsUpdate {
	rlou.mutation.SetThrottlePercentage(s)
	return rlou
}
...
func (rlou *RateLimitOptionsUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := rlou.mutation.DurationInSeconds(); ok {
		_spec.SetField(ratelimitoptions.FieldDurationInSeconds, field.TypeString, value)
	}
	if value, ok := rlou.mutation.ThrottlePercentage(); ok {
...
// SetDurationInSeconds sets the "duration_in_seconds" field.
func (rlouo *RateLimitOptionsUpdateOne) SetDurationInSeconds(s string) *RateLimitOptionsUpdateOne {
	rlouo.mutation.SetDurationInSeconds(s)
	return rlouo
}

// SetThrottlePercentage sets the "throttle_percentage" field.
func (rlouo *RateLimitOptionsUpdateOne) SetThrottlePercentage(s string) *RateLimitOptionsUpdateOne {
	rlouo.mutation.SetThrottlePercentage(s)
	return rlouo
}
...
func (rlouo *RateLimitOptionsUpdateOne) sqlSave(ctx context.Context) (_node *RateLimitOptions, err error) {
	...
	if value, ok := rlouo.mutation.DurationInSeconds(); ok {
		_spec.SetField(ratelimitoptions.FieldDurationInSeconds, field.TypeString, value)
	}
	if value, ok := rlouo.mutation.ThrottlePercentage(); ok {
		_spec.SetField(ratelimitoptions.FieldThrottlePercentage, field.TypeString, value)
	}

...
func (rloc *RateLimitOptionsCreate) SetNillableTokenCount(s *string) *RateLimitOptionsCreate {
	if s != nil {
		rloc.SetTokenCount(*s)
	}
	return rloc
}

// SetDuration sets the "duration" field.
func (rloc *RateLimitOptionsCreate) SetDuration(s string) *RateLimitOptionsCreate {
	rloc.mutation.SetDuration(s)
	return rloc
}
...
func (rloc *RateLimitOptionsCreate) check() error {
	...
	if _, ok := rloc.mutation.Duration(); !ok {
		return &ValidationError{Name: "duration", err: errors.New(`gen: missing required field "RateLimitOptions.duration"`)}
	}
	return nil
}
...
func (rloc *RateLimitOptionsCreate) createSpec() (*RateLimitOptions, *sqlgraph.CreateSpec) {
	...
	if value, ok := rloc.mutation.Duration(); ok {

...
func (*RateLimitOptions) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case ratelimitoptions.FieldClientID, ratelimitoptions.FieldTokenCount, ratelimitoptions.FieldDuration:
...
func (rlo *RateLimitOptions) String() string {
	...
	builder.WriteString(rlo.Duration)
	builder.WriteString(", ")
